...
public class KGPSummers {
  ...
  public KGPSummers( int[] studentsRoom, int[] classroom, int[][] trees) {
	 N = trees.length;
  ...
  public static void main(String args[]) {
  		...
  		try {
//  		   File file = new File("/Users/dave/code/algorithms/codechef/KGPSummers/src/sample.txt");
//		   scanner = new Scanner(file);
    ...
    for(int i = 0; i < T; i++) {
    	...
    	for(int j = 0; j < N; j++ ) {
    		trees[j][0] = scanner.nextInt();
    		trees[j][1] = scanner.nextInt();
    	}
    	int[] studentsRoom = new int[2];
    	studentsRoom[0] = scanner.nextInt();
    	studentsRoom[1] = scanner.nextInt();
    	int[] classroom = new int[2];
    	classroom[0] = scanner.nextInt();
    	classroom[1] = scanner.nextInt();
